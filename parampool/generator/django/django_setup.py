...
def fix_settings(projectname, appname, project_dir, login):
    ...
    code = """ \
# Django settings for %(projectname)s project.
...
SECRET_KEY = 'l2*st+=!4##qex^@=!o&amp;h4_z)eqb9q@3l0vc^sdp6vxn+u3)s0'
...
ROOT_URLCONF = '%(projectname)s.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = '%(projectname)s.wsgi.application'
