...
# Menu object (must be imported before compute_motion_and_forces_with_menu_menu_definition_api_models
...
from compute_motion_and_forces_with_menu_menu_definition_api_models import MotionAndForcesWithMenu, MotionAndForcesWithMenuForm
...
def index(request):
    ...
    return render_to_response(
        "compute_motion_and_forces_with_menu_menu_definition_api_index.html",
        {"form": form,
         "result": result,
        },
