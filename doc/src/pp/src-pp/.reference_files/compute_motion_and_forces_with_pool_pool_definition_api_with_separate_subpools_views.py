...
# Pool object (must be imported before compute_motion_and_forces_with_pool_pool_definition_api_with_separate_subpools_models
...
from compute_motion_and_forces_with_pool_pool_definition_api_with_separate_subpools_models import MotionAndForcesWithPool, MotionAndForcesWithPoolForm
...
def index(request):
    ...
    return render_to_response(
        "compute_motion_and_forces_with_pool_pool_definition_api_with_separate_subpools_index.html",
        {"form": form,
         "result": result,
        },
