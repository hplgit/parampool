...
# Pool object (must be imported before compute_motion_and_forces_with_pool_pool_definition_api_model)
...
from compute_motion_and_forces_with_pool_pool_definition_api_model import MotionAndForcesWithPool
...
def index():
    ...
    return render_template("compute_motion_and_forces_with_pool_pool_definition_api_view.html", form=form, result=result)
