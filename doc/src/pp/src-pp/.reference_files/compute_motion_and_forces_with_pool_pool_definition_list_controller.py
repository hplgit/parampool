...
# Pool object (must be imported before compute_motion_and_forces_with_pool_pool_definition_list_model)
...
from compute_motion_and_forces_with_pool_pool_definition_list_model import MotionAndForcesWithPool
...
def index():
    ...
    return render_template("compute_motion_and_forces_with_pool_pool_definition_list_view.html", form=form, result=result)
